                                        ...
                                        <div class="actions">
                                            <div class="btn-group btn-group-devided" data-toggle="buttons">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li>
                                                        <a href="#tab_1_2" data-toggle="tab" class="toggle">Eliminar </a>
                                                    </li>
                                                    <li>
...
<script type="text/javascript">
    ...
    $(document).on("ready", function () {
        ...
        $("#btn_buscar").on("click", function () {
            ...
            var url = "<?php echo base_url(); ?>POI_Map/buscar";
            $.ajax({
                type: "POST",
                dataType: "JSON",
                url: url,
                ...
                success: function (data) {
                    if (data.estado == "ok")
                    {
                        $.each(data.mensaje, function (i, item) {
                            $("<option data-cx='" + item.latitude + "' data-cy='" + item.longitude + "' value='" + item.id + "'>" + item.name_pois + "</option>")
